...
class NetworkService {
    ...
    func httpRequest<T: Codable>(url: URL?, expecting: T.Type) async throws -> T {
        ...
        request.setValue("""
        Digest username="f811o0f7klopw8f88dosn39l8dlai3nx", \
        realm="apimob", \
        nonce="1701720515.6795354:BBFC:cb9ec07d72aeaa39e23e6d0b22ec39c8", \
        uri="/apimob/v1/search-artist/?q=tup&format=json&ac=1", \
        response="c15ae0a355a7d026f21b39a7219c7e19", \
        opaque="ee78f269db532c3871a921ed10d11d24ca7ff3fb", \
        algorithm="MD5", \
        cnonce="64888b6c4567afab9bc7b55568f264a6", \
        nc=00000003, \
        qop="auth"
